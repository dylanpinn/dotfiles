...
if [ "${1:-}" = "--tarball-url-prefix" ]; then
    ...
    url=https://releases.nixos.org/nix/nix-2.17.0/nix-2.17.0-$system.tar.xz
fi

tarball=$tmpDir/nix-2.17.0-$system.tar.xz
...
echo "downloading Nix 2.17.0 binary tarball for $system from '$url' to '$tmpDir'..."
